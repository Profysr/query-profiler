...
#     # Exclude DQS's own dashboard routes from the list of discovered endpoints, so the tool never offers to "run" itself.
#     DQS_URL_PREFIX = "dqs/"
...
#         """
#         # Same production guardrail the Sandbox Runner enforces
...
#             # Recurse into it, remembering the path prefix we walked through to get here, so the final path is complete (e.g. "api/" + "books/").
